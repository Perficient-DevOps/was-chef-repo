#*************************************************************************
# Script: startAppServer.py - Start Application Server
#
# Description:   Simple script to start applications server on given node. 
#
# Parameters:
...
#			/ -f startAppServer.py "mnNode" "myServer" "YES"
# Author:
#	Bruce Ryba
# Date: 02/07/2018
#
...
try:
	# execute the startAppServer function from the AdminApplication library
	rtn=AdminServerManagement.startSingleServer(sys.argv[0],sys.argv[1])
	if debug == "YES":
	...
	print val
	sys.exit(2)
print "Applicaiton Server started."  
sys.exit(0)
